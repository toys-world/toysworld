...
contract GemsToken is Context, IERC20, Ownable {
    ...
    uint256 private constant MAX = 10000000000000000000000000;
    uint256 private _tTotal = 0;
    uint256 private _inital_lp = 10000000000000000000000000;
    ...
    string private constant _name = "Toys Gems Token";
    string private constant _symbol = "T-Gems";
    ...
    function setSellFeeRates(uint256 _burns) external {
        ...
        require(msg.sender == nodeAddresss || msg.sender == owner(),"Only Owner can set Fees");
    ...
    function burnToken(uint256 _amount) external {
         require(_amount <= balanceOf(msg.sender),"You are trying to transfer more than your balance");
